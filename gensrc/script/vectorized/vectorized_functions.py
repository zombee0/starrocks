...
vectorized_functions = [
    ...
    # map functions
    [170000, 'map_size', 'INT', ['ANY_MAPTYPE'], 'MapFunctions::map_size'],
    [170001, 'map_keys', 'ANY_ARRAY', ['ANY_MAPTYPE'], 'MapFunctions::map_keys'],
    [170002, 'map_values', 'ANY_ARRAY', ['ANY_MAPTYPE'], 'MapFunctions::map_values'],
]
