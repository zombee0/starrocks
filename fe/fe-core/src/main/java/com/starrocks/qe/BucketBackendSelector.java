...
public class BucketBackendSelector implements BackendSelector {
    public static final Logger LOG = LogManager.getLogger(BucketBackendSelector.class);
    ...
    public BucketBackendSelector(ScanNode scanNode, List<TScanRangeLocations> locations,
                                 ...
                                 boolean useIncrementalScanRanges, ConnectContext connectContext) {
    ...
    public void computeScanRangeAssignment() throws StarRocksException {
        ...
        HashRing hashRing = new RendezvousHashRing(Hashing.murmur3_128(), new BucketIdFunnel(),
