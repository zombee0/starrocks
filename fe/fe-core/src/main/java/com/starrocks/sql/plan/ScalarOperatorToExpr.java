...
public class ScalarOperatorToExpr {
    ...
    public static class Formatter extends ScalarOperatorVisitor<Expr, FormatterContext> {
        ...
        @Override
        public Expr visitCollectionSub(CollectionSubscriptOperator node, FormatterContext context) {
            return new CollectionSubscriptExpr(node.getType(), buildExpr.build(node.getChild(0), context),
